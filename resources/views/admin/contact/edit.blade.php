...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('message', old('message',$contact->message), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('user_id', 'From User', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::select('user_id', $user, old('user_id',$contact->user_id), array('class'=>'form-control')) !!}
